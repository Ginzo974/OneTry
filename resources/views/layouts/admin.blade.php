...
<body class="class=" antialiased bg-gray-100 dark:bg-gray-900">
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-nav-link :href="route('admin.voitures.index')"
                    :active="request()->routeIs('admin.voitures.index')">
        ...
        <main class="m-2 p-8 w-full">
            <div>
                ...
                <div class="p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800"
                    role="alert">
                    <span class="font-medium">Success alert!</span> {{ session()->get('succès')}}
                </div>
                @endif
                ...
                <div class="p-4 mb-4 text-sm text-yellow-700 bg-yellow-100 rounded-lg dark:bg-yellow-200 dark:text-yellow-800"
                    role="alert">
                    <span class="font-medium">Warning alert!</span>{{ session()->get('attention')}}
                </div>
                @endif
            </div>
            {{$slot}}
